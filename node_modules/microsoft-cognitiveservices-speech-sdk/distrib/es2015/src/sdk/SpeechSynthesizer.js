...
import { CognitiveSubscriptionKeyAuthentication, CognitiveTokenAuthentication, Context, OS, SpeechServiceConfig, SpeechSynthesisConnectionFactory, SynthesisAdapterBase, SynthesizerConfig, } from "../common.speech/Exports";
...
export class SpeechSynthesizer {
    ...
    static buildSsml(text, properties) {
    ...
    adapterSpeak() {
        if (!this.privDisposed && !this.privSynthesizing) {
            ...
            return this.synthesisRequestQueue.dequeue().
                onSuccessContinueWithPromise((request) => {
